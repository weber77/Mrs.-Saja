...
if(isset($_POST['UserName']))
{
	...
	if(isset($_COOKIE['ShoppingCart']) && $_COOKIE['ShoppingCart'] != "")
	{
		...
		$statement1 = $dbh->prepare('SELECT id FROM clients WHERE user_name = ? ; ');
		...
		if($row = $statement1->fetch(PDO::FETCH_ASSOC))
		{
			...
			$statement2 = $dbh->prepare('INSERT INTO orders (clients_id) VALUES (?); ');
			...
			$statement3 = $dbh->prepare('INSERT INTO orders_products (orders_id, products_id, quantity) VALUES (?,?,1); ');
